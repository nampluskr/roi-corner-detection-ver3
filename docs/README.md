...
| 8 | [08-offset.md](models/08-offset.md) | `offset` canonical square offset regression |
...
한다. model registry는 다음 12개 선택자를 제공한다.

```text
reg, offset, seg, det, peak, ridge, gcn, hybrid, torchseg, torchdet, yolo, detr
```
