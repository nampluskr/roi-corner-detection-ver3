...
ver1 project에는 이 주제를 다룬 `docs/common/roi-corner-detection-data-pipeline.md`와 F1-F8 제약을
정의한 `docs/common/roi-corner-detection-models.md`가 있다. 이번 plan은 이 두 문서를 참고 자료로 삼아
ver3 문서 규칙과 현재 구현 용어에 맞게 재작성한다. 참고 문서 내부 파일은 읽기 전용으로만 사용한다.
