# src/methods/detr/wrapper.py: wraps DetrModel with Hugging Face native Hungarian loss semantics
...
from src.methods.detr.model import DetrModel
from src.methods.detr.preprocessor import DetrPreprocessor
from src.methods.detr.postprocessor import DetrPostprocessor
...
class DetrWrapper(BaseWrapper):
    ...
    def __init__(self, backbone=None, head="box", model=None, box_size=None, image_size=224,
        ...
        # backbone/image_size kwargs accepted for CLI compatibility; unused by HF DETR here
