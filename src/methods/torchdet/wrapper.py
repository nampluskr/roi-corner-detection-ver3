# src/methods/torchdet/wrapper.py: wraps TorchDetModel with native torchvision detection semantics
...
from src.methods.torchdet.model import TorchDetModel
from src.methods.torchdet.preprocessor import TorchDetPreprocessor
from src.methods.torchdet.postprocessor import TorchDetPostprocessor
...
class TorchDetWrapper(BaseWrapper):
    ...
    def __init__(self, backbone=None, head="box", model=None, box_size=None, image_size=224,
                 optimizer=None, scheduler=None, preprocessor=None, postprocessor=None,
                 metrics=None, device=None, warmup_epochs=1):
        # backbone kwarg accepted for CLI compatibility with get_wrapper_kwargs; unused here
