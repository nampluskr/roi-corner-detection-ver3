# src/methods/det/wrapper.py: composes DetModel with DetPreprocessor/DetPostprocessor and Focal+SmoothL1 loss

from torch.optim import AdamW
from torch.optim.lr_scheduler import ReduceLROnPlateau

from src.methods.base.wrapper import BaseWrapper
from src.methods.det.model import DetModel
from src.methods.det.preprocessor import DetPreprocessor
from src.methods.det.postprocessor import DetPostprocessor
...
class DetWrapper(BaseWrapper):
    ...
    def __init__(self, in_channels=3, backbone="custom", head="box", neck_channels=256,
