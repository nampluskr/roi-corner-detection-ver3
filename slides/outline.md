...
corner label을 변환 parameter에서 오차 없이 자동으로 얻는다. 이는 subpixel 제약 F5와 부합한다. data
전략의 상세는 [Data Strategy](../docs/architecture/05-data-strategy.md)에서 다룬다.
...
## 페이지 10. 조립 3축: model, network, head
...
## 페이지 13. reg (Direct Coordinate Regression)
...
## 페이지 14. seg (Binary ROI Segmentation)
...
## 페이지 15. peak (Dense Corner Heatmap)
...
## 페이지 17. det (Custom Grid Detection)
...
## 페이지 18. gcn (Iterative Graph Refinement)
...
## 페이지 19. hybrid (Learned Mask + Classical Geometry)
